...
require('lazy').setup({
...

  {
    ...
    priority = 1000, -- higher than other plugins
    config = function()
      require('guess-indent').setup {
        -- you can tweak its detection parameters here:
        -- sample_size = 1000,
        -- tolerance   = 5,
      }
    end,
  ...
  },
  {
    ...
    config = function()
      ...
      local servers = {
        ...
        --
        -- But for many setups, the LSP (`ts_ls`) will work just finelsp
        ts_ls = {},
        --
